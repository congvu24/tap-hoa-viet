...
import com.annhienktuit.fruitclassification.env.ImageUtils;
import com.annhienktuit.fruitclassification.env.Logger;
import com.annhienktuit.fruitclassification.tflite.Classifier;
...
public abstract class CameraActivity extends AppCompatActivity
    ...
    protected void showResultsInBottomSheet(List<Classifier.Recognition> results) {
        if (results != null && results.size() >= 3) {
            ...
            if (recognition != null && recognition.getConfidence() > 0.7f) {
                ...
                recognitionTextView.setText("Cannot detect");
                recognitionValueTextView.setText("0%");
                recognition1TextView.setText("Cannot detect");
                recognition1ValueTextView.setText("0%");
                recognition2TextView.setText("Cannot detect");
