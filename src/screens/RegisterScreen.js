...
export default function RegisterScreen({navigation}) {
    ...
    const [errorText,setErrorText] = useState('Registration is currently not complete');
                ...
                <ScrollView style={styles.bottomSection} contentContainerStyle={{flexGrow: 1, justifyContent: 'center'}}>                
                    <View style={{justifyContent:'center',alignItems:'center',height:'100%'}}>
                            ...
                            <View style={{width:'80%',marginBottom:20}}>
                                <Text style={{color:'#303030',fontSize:40,marginTop:10,marginBottom:24}}>Create {'\n'}Account</Text> 
                                <TextInput 
                                    value={name} 
                            ...
                            <AuthButton buttonFunction={()=>validate()} bgcolor="white" text="Sign up" color={"black"} outline={false}/>
                    </View>
                </ScrollView>
            </View>
            <Overlay isVisible={error}>
                <PopUp errorBtn={()=>setError(false)} text={errorText} error={popUpErr} />
            </Overlay>

            <Overlay isVisible={registered}>
                <PopUp successBtn={()=>SignUpSuccess()} text={"Welcome to Tap Hoa Viet."} />
            </Overlay>
